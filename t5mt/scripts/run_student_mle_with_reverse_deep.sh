...
#SBATCH --output=slurm-logs/slurm-%j-wmt-student-mle-with-reverse-matching-deeper-decoder-fixed-layer-copy.out

nvidia-smi

export TEACHER=models/wmt-teacher-t5-base/best_tfmr
export OUTPUT_NAME=student-mle-reverse-deep-fixed-layer-copy-$(date +%m-%d-%y--%T)
...
python distillation.py \
  ...
  --alpha_hid=1. --alpha_ce=0. --alpha_mlm=1.\
