...
#SBATCH --output=slurm-logs/slurm-%j-wmt-student-mle-with-reverse-matching-redo-with-copied-layers.out

nvidia-smi

export TEACHER=models/wmt-teacher-t5-base/best_tfmr
export OUTPUT_NAME=student-mle-reverse-fixed-copy-layer-$(date +%m-%d-%y--%T)
